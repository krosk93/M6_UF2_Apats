...
module.exports = {
  ...
  'Add Starter': function test (browser) {
    ...
    browser
      ...
      .click('select#newDifficulty option[value="2"]')
      .click('select#newScore option[value="4"]')
  ...
  'Add Various Meals': function test (browser) {
    ...
    browser
      ...
      .click('select#newDifficulty option[value="0"]')
      .click('select#newScore option[value="2"]')
      ...
      .click('select#newDifficulty option[value="1"]')
      .click('select#newScore option[value="2"]')
